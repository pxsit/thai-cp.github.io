...
<img src="../../assets/graph-representation/edge-list-unweighted.jpg" alt="" width="800">

* ถ้าจะเก็บ weighted graph ให้ ใช้เป็น `vector<pair<pair<int, int>, int>>` (ใช้ struct หรือ tuple ก็ได้ แล้วแต่ถนัด)
...
<img src="../../assets/graph-representation/edge-list-weighted.jpg" alt="" width="800">
...
> Example:
<img src="../../assets/graph-representation/adjacency-matrix-weighted.jpg" alt="" width="800">
...
> Example: Unweighted Graph
<img src="../../assets/graph-representation/adjacency-list-unweighted.jpg" alt="" width="800">

* ถ้าจะเก็บ weighted graph ให้ใช้เป็น `vector<pair<int, int>>` แทน ซึ่งแต่ละ pair เก็บ `{เลข vertex ที่ไปหา, weight ของ edge นั้น}`

> Example: Weighted Graph
<img src="../../assets/graph-representation/adjacency-list-weighted.jpg" alt="" width="800">
